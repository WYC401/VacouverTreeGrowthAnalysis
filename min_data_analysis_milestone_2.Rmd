...
4. For the 4th research problem, the density plot shows the difference between the tree diameter with root barriers and without. It is clear that the diameter of trees with barrier tend to center on 3. And the trees without barrier have more freedom in their diameters with a much higer mean--10. They can grow wildly. Still, we will ask further about if it is possible to tell apart the trees with and without root barriers by using their diameter data. 
